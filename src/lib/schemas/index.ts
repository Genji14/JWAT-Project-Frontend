...
export const createUserSchema = z.object({
    ...
    gender: z.enum([Gender.FEMALE, Gender.MALE, Gender.OTHER], {
        ...
        invalid_type_error: 'Gender must be one of the following values: MALE, FEMALE, OTHER',
    }),
    dob: z.date({
    ...
    roles: z.enum([UserRole.ADMIN, UserRole.EMPLOYEE, UserRole.ADMIN], {
        required_error: 'Role is required',
        invalid_type_error: 'Role must be one of the following values: ADMIN, EMPLOYEE, MANAGER',
    }),
})