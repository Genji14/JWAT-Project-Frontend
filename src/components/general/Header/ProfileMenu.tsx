        ...
        <Popover>
            <PopoverTrigger asChild>
                <Avatar className='cursor-pointer'>
                    <AvatarImage
                        src={
                            currentUserInfoData?.media
                                ? currentUserInfoData.media.url
                                : undefined
                        }
                    />
                    <AvatarFallback>
                        {convertAlt(currentUserInfoData?.fullName!)}
                    </AvatarFallback>
                </Avatar>
            </PopoverTrigger>
            <PopoverContent
            ...
            >
                ...
                <div
                    className='flex cursor-pointer items-center gap-2 rounded px-3 py-1.5 text-sm font-semibold hover:bg-accent'
